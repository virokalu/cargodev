...
function SelectItem({
  ...
  /** Skip the right-aligned checkmark — for items that already show
   * selection another way (e.g. a colour-swatch row tinted with its own
   * colour), where the checkmark would just crowd a narrow column. */
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        hideIndicator ? "px-1.5" : "pr-8 pl-1.5",
        className
      )}
      {...props}
    >
